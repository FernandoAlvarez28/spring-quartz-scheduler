...
@Component
public class FakeOrderDispatchJobSchedulerImpl extends JobScheduler {
	
	private final JobDetail jobDetail;
	
	private final Trigger trigger;
	
	public FakeOrderDispatchJobSchedulerImpl() {
		super(Jobs.FAKE_ORDER_DISPATCH_JOB);
		...
		this.trigger = TriggerBuilder.newTrigger()
				...
				.withDescription("Repeat every 2 minutes")
